...
export default function Home() {
  ...
  async function getRecs() {
    ...
    try {
      ...
      // Acumula títulos já recomendados (máximo 30)
      setPreviousTitles(prev =>
        [...prev, ...data.games.map((g: Game) => g.title)].slice(-30)
      )
    } catch {
      setError(true)
    } finally {
  ...
  // Reseta histórico quando troca de gênero
        ...
        <>
          ...
          {error && (
            <div className="error-box">
              ⚠ Erro ao buscar recomendações. Verifique sua GROQ_API_KEY e tente novamente.
            </div>
          )}
